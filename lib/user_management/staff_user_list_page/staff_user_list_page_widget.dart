...
import '/components/search_staff_dialog_comp_widget.dart';
...
export 'staff_user_list_page_model.dart';

class StaffUserListPageWidget extends StatefulWidget {
  const StaffUserListPageWidget({super.key});

  static String routeName = 'StaffUserListPage';
  static String routePath = '/staffUserListPage';

  @override
  State<StaffUserListPageWidget> createState() =>
      _StaffUserListPageWidgetState();
}

class _StaffUserListPageWidgetState extends State<StaffUserListPageWidget> {
  late StaffUserListPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StaffUserListPageModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.staffListInitRaw = await actions.adminGetUserListItems(
        'staff',
        '',
        false,
        '',
      ...
      FFAppState().staffUserListStruct =
          _model.staffListInitRaw!.toList().cast<AdminUserListItemStruct>();
      safeSetState(() {});
    });

    _model.staffBulkFreezeReasonFieldTextController ??= TextEditingController();
    _model.staffBulkFreezeReasonFieldFocusNode ??= FocusNode();
  }
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: [
                                                                      ...
                                                                      Expanded(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                              () async {
                                                                            context.pushNamed(
                                                                              StaffUserdetailsPageWidget.routeName,
                                                                              queryParameters: {
                                                          ...
                                                          TextFormField(
                                                            ...
                                                            focusNode: _model
                                                                .staffBulkFreezeReasonFieldFocusNode,
                                                            obscureText: false,
                                                            decoration:
                                                                InputDecoration(
                                                              labelText:
