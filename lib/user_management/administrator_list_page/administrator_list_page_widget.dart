...
export 'administrator_list_page_model.dart';

class AdministratorListPageWidget extends StatefulWidget {
  const AdministratorListPageWidget({super.key});

  static String routeName = 'AdministratorListPage';
  static String routePath = '/administratorListPage';

  @override
  State<AdministratorListPageWidget> createState() =>
      _AdministratorListPageWidgetState();
}
...
class _AdministratorListPageWidgetState
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdministratorListPageModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.administratorListInitRaw = await actions.adminGetUserListItems(
        'admin',
        '',
        false,
        '',
      ...
      FFAppState().administratorListStruct = _model.administratorListInitRaw!
          .toList()
                                                          ...
                                                          return Dialog(
                                                            ...
                                                            child:
                                                              ...
                                                              child: Container(
                                                                ...
                                                                width: 760.0,
                                                                child:
                                                                    SearchAdministratorDialogCompWidget(),
                                                              ),
                                                            ),
                                                          );
                                                        },
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          ...
                                                          TextFormField(
                                                            ...
                                                            focusNode: _model
                                                                .adminBulkFreezeReasonFieldFocusNode,
                                                            obscureText: false,
                                                            decoration:
                                                                InputDecoration(
                                                              labelText:
