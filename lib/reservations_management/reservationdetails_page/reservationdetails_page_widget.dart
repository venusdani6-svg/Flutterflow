...
class ReservationdetailsPageWidget extends StatefulWidget {
  ...
  @override
  State<ReservationdetailsPageWidget> createState() =>
      _ReservationdetailsPageWidgetState();
}

class _ReservationdetailsPageWidgetState
    extends State<ReservationdetailsPageWidget> {
  late ReservationdetailsPageModel _model;
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.reservationExtrasList = _model.reservationExtrasInit;
      safeSetState(() {});
    });

    _model.forceCancelReasonFieldTextController ??= TextEditingController();
    _model.forceCancelReasonFieldFocusNode ??= FocusNode();

    _model.manualRefundReasonFieldTextController ??= TextEditingController();
    _model.manualRefundReasonFieldFocusNode ??= FocusNode();
  }
