...
class SearchReservationDialogCompWidget extends StatefulWidget {
  const SearchReservationDialogCompWidget({super.key});

  @override
  State<SearchReservationDialogCompWidget> createState() =>
      _SearchReservationDialogCompWidgetState();
}

class _SearchReservationDialogCompWidgetState
    extends State<SearchReservationDialogCompWidget> {
  late SearchReservationDialogCompModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SearchReservationDialogCompModel());
