...
class ReservationsManagementPageWidget extends StatefulWidget {
  const ReservationsManagementPageWidget({super.key});

  static String routeName = 'ReservationsManagementPage';
  static String routePath = '/reservationsManagementPage';

  @override
  State<ReservationsManagementPageWidget> createState() =>
      _ReservationsManagementPageWidgetState();
}
