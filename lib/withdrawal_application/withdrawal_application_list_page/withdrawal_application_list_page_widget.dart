...
class WithdrawalApplicationListPageWidget extends StatefulWidget {
  const WithdrawalApplicationListPageWidget({super.key});

  static String routeName = 'WithdrawalApplicationListPage';
  static String routePath = '/withdrawalApplicationListPage';

  @override
  State<WithdrawalApplicationListPageWidget> createState() =>
      _WithdrawalApplicationListPageWidgetState();
}
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Container(
                                        ...
                                        child: const PayoutListBodyWidget(),
                                      ),
                                    ),
                                  ].divide(SizedBox(width: 8.0)),
                                ),
