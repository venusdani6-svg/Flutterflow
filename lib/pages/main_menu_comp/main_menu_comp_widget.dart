          ...
          child: Column(
            ...
            children: [
              ...
              InkWell(
                ...
                onTap: () async {
                  context.pushNamed(
                    UserManagementPageWidget.routeName,
                    extra: <String, dynamic>{
                      '__transition_info__': TransitionInfo(
                        hasTransition: true,
                        transitionType: PageTransitionType.fade,
              ...
              InkWell(
                ...
                onTap: () async {
                  context.pushNamed(
                    ReservationsManagementPageWidget.routeName,
                    extra: <String, dynamic>{
                      '__transition_info__': TransitionInfo(
                        hasTransition: true,
                        transitionType: PageTransitionType.fade,
              ...
              InkWell(
                ...
                onTap: () async {
                  context.pushNamed(
                    PaymentLedgerManagementPageWidget.routeName,
                    extra: <String, dynamic>{
                      '__transition_info__': TransitionInfo(
                        hasTransition: true,
                        transitionType: PageTransitionType.fade,
              ...
              InkWell(
                ...
                onTap: () async {
                  context.pushNamed(
                    WithdrawalApplicationManagementPageWidget.routeName,
                    extra: <String, dynamic>{
                      '__transition_info__': TransitionInfo(
                        hasTransition: true,
                        transitionType: PageTransitionType.fade,
              ...
              InkWell(
                ...
                onTap: () async {
                  context.pushNamed(
                    KYCReviewManagementPageWidget.routeName,
                    extra: <String, dynamic>{
                      '__transition_info__': TransitionInfo(
                        hasTransition: true,
                        transitionType: PageTransitionType.fade,
              ...
              InkWell(
                ...
                onTap: () async {
                  context.pushNamed(
                    ReportManagementPageWidget.routeName,
                    extra: <String, dynamic>{
                      '__transition_info__': TransitionInfo(
                        hasTransition: true,
                        transitionType: PageTransitionType.fade,
              ...
              InkWell(
                ...
                onTap: () async {
                  context.pushNamed(
                    AffiliateManagementPageWidget.routeName,
                    extra: <String, dynamic>{
                      '__transition_info__': TransitionInfo(
                        hasTransition: true,
                        transitionType: PageTransitionType.fade,
              ...
              InkWell(
                ...
                onTap: () async {
                  context.pushNamed(
                    CocomiseManagementPageWidget.routeName,
                    extra: <String, dynamic>{
                      '__transition_info__': TransitionInfo(
                        hasTransition: true,
                        transitionType: PageTransitionType.fade,
              ...
              InkWell(
                ...
                onTap: () async {
                  context.pushNamed(
                    JobBoardManagementPageWidget.routeName,
                    extra: <String, dynamic>{
                      '__transition_info__': TransitionInfo(
                        hasTransition: true,
                        transitionType: PageTransitionType.fade,
              ...
              InkWell(
                ...
                onTap: () async {
                  context.pushNamed(
                    BannerManagementPageWidget.routeName,
                    extra: <String, dynamic>{
                      '__transition_info__': TransitionInfo(
                        hasTransition: true,
                        transitionType: PageTransitionType.fade,
              ...
              InkWell(
                ...
                onTap: () async {
                  context.pushNamed(
                    SystemSettingsManagementPageWidget.routeName,
                    extra: <String, dynamic>{
                      '__transition_info__': TransitionInfo(
                        hasTransition: true,
                        transitionType: PageTransitionType.fade,
              ...
              InkWell(
                ...
                onTap: () async {
                  context.pushNamed(
                    AuditLogManagementPageWidget.routeName,
                    extra: <String, dynamic>{
                      '__transition_info__': TransitionInfo(
                        hasTransition: true,
                        transitionType: PageTransitionType.fade,
