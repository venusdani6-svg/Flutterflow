...
import '/pages/admin_dashboard_page/dashboard_activity_log_card.dart';
import '/index.dart';
...
class _AdminDashboardPageWidgetState extends State<AdminDashboardPageWidget> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      await _model.loadDashboardData(() => safeSetState(() {}));
    });
  }
      ...
      child: Scaffold(
        ...
        body: Stack(
          ...
          child: Visibility(
                                              ...
                                              children: [
                                                ...
                                                Expanded(
                                                  child: InkWell(
                                                    ...
                                                    onTap: () async {
                                                      context.pushNamed(
                                                        ReservationsManagementPageWidget
                                                            .routeName,
                                                        extra: <String,
                                                            dynamic>{
                                                          '__transition_info__':
                                                ...
                                                Expanded(
                                                  child: InkWell(
                                                    ...
                                                    onTap: () async {
                                                      context.pushNamed(
                                                        PaymentLedgerManagementPageWidget
                                                            .routeName,
                                                        extra: <String,
                                                            dynamic>{
                                                          '__transition_info__':
                                              ...
                                              children: [
                                                ...
                                                Expanded(
                                                  child: InkWell(
                                                    ...
                                                    onTap: () async {
                                                      context.pushNamed(
                                                        SystemSettingsManagementPageWidget
                                                            .routeName,
                                                        extra: <String,
                                                            dynamic>{
                                                          '__transition_info__':
            ...
            if (_model.dashboardLoadError != null)
              Align(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        Expanded(
                          child: Text(
                            'データ取得エラー: ${_model.dashboardLoadError}',
                        ...
                        IconButton(
                          ...
                          onPressed: () async {
                            await _model.loadDashboardData(
                              () => safeSetState(() {}),
                            );
                          },
                        ),
  ...
  Widget _buildActivityLogSection(BuildContext context) {
    if (_model.activityLogs.isEmpty) {
      return Padding(
    ...
    return SingleChildScrollView(
      child: Column(
        mainAxisSize: MainAxisSize.max,
        children: _model.activityLogs
            .map(
              (log) => DashboardActivityLogCard(log: log),
            )
            .toList()
