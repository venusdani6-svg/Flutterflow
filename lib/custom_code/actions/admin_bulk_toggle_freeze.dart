...
/// - reason (String?) optional — admin-typed audit-log reason, forwarded
///   to every looped adminToggleFreeze call
///
...
Future<dynamic> adminBulkToggleFreeze(
  ...
  for (final id in ids) {
    try {
      await callable.call({'user_id': id, 'freeze': freeze, 'reason': reason});
      successCount++;
    } catch (e) {
