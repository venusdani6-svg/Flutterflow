...
export 'banner_form_dialog_comp_model.dart';

class BannerFormDialogCompWidget extends StatefulWidget {
  const BannerFormDialogCompWidget({
    super.key,
    this.existingBanner,
  });

  final dynamic existingBanner;

  @override
  State<BannerFormDialogCompWidget> createState() =>
      _BannerFormDialogCompWidgetState();
}

class _BannerFormDialogCompWidgetState
    extends State<BannerFormDialogCompWidget> {
  late BannerFormDialogCompModel _model;
                ...
                children: [
                  Flexible(
                    child: FlutterFlowDropDown<String>(
                      ...
                      options: List<String>.from(['home', 'cocoten']),
                      optionLabels: ['ホーム', 'ココ店'],
                      onChanged: (val) =>
